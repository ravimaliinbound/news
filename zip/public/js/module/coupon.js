...
$(document).on('change','#category',function(){
    var cat_id = $(this).val();
    $.ajax({
        url: "/jmarkt-admin/coupon/subcategory",
        method:'POST',
        data:{ cat_id : cat_id},
...
$(document).on("change",".subcategories",function(){
    ...
    $.ajax({
        ...
        url:"/jmarkt-admin/coupon/get-product-list",
...
$(document).on('change', '.verificationStatus', function(){
    var id = $(this).data('id');
    $.ajax({
        url: "/jmarkt-admin/coupon/change-verification-status",
        method:'POST',
...
$(document).on('change', '.couponStatus', function(){
    ...
    var id = $(this).data('id');
    $.ajax({
        url: "/jmarkt-admin/coupon/change-coupon-status",
        method:'POST',
