            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body pt-0"> 
                        ...
                        <div class="p-2">
                            <form class="form-horizontal" action="{{ route('vendor.postlogin') }}" id="loginForm" method="post">
                                @csrf
                                ...
                                <div class="mt-4 text-center">
                                    <a href="{{ route('vendor.auth.password.reset') }}" class="text-muted"><i class="mdi mdi-lock me-1"></i> Forgot your password?</a> <br /><br />
