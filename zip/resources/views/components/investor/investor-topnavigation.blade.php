    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('investor.dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                ...
                <a href="{{ route('investor.dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
        ...
        <div class="d-flex">
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="initials"> {{ generateInitials(Auth::guard('investor')->user()->name) }}</span>
