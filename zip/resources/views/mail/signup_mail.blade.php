                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                We are happy to inform you that your registration as an exhibitor for PLEXPOINDIA 2024, hosted by the prestigious GUJARAT STATE PLASTIC MANUFACTURERS ASSOCIATION (GSPMA), has been successfully processed.
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                Your participation adds immense value to our event, and we are committed to ensuring your experience is nothing short of exceptional.
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                To ensure we tailor our offerings to your needs seamlessly, we kindly request you to complete your stall requirements by logging in to your panel using your registered email id.
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                <a href="https://exhibitor.plexpoindia.org/dietician-panel/login" target="_blank"><b>Login Here To Continue</b></a>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                Thank you for choosing to be a part of PLEXPOINDIA 2024. We look forward to welcoming you and showcasing your contributions to the esteemed delegates attending this premier event.
                                                            </td>
                                                        </tr>
