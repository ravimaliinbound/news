            ...
            <tr>
                <td>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="100%">
                                <img src="https://exhibitor.plexpoindia.org/images/mail-header.jpeg" style="margin: 0; border: 0; padding: 0; display: block; width: 100%; max-width: 600px;"/>
                            </td>
                        </tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="title-font" style="font-family: LATO LIGHT, sans-serif;font-size: 20px; line-height: 24px;color: #005040;font-weight: bold;">
                                                                Dear <?php echo $data['company_name'];?>,
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                We wanted to inform you of some adjustments to your participation details for PLEXPOINDIA 2024. After a careful review of the information provided for <?php echo $data['company_name'];?> we have made a few necessary changes. The updated proforma invoice is attached to this email. <br/><br/>

                                                                Here is the updated breakup of pricing and stall requirements:
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                <table cellspacing="5px" cellpadding="5px" border="1" width="100%" style="border: 1px solid black;border-collapse: collapse;">
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $data['conname'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Email ID:</b></td>
                                                                        <td><?php echo $data['conemail'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Mobile Number:</b></td>
                                                                        <td><?php echo $data['conmobile'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                <table cellspacing="5px" cellpadding="5px" border="1" width="100%" style="border: 1px solid black;border-collapse: collapse;">
                                                                    <tr>
                                                                        <td colspan="2"><b>Stall Requirements</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Space Size:</b></td>
                                                                        <td><?php echo $data['space_size'];?> Sq. Mt.</td>
                                                                    </tr>
                                                                    <?php
                                                                        $type = ['SHELL' => 'Shell','DESIGN' => 'Shell + Design', 'BARE' => 'Bare'];
                                                                    ?>
                                                                    <tr>
                                                                        <td><b>Space Type:</b></td>
                                                                        <td><?php echo $type[$data['space_type']];?></td>
                                                                    </tr>
                                                                    <?php
                                                                        $side = ['ONESIDE' => 'Front-Side Open','TWOSIDE' => 'Two-Side Open' ,'THREESIDE' => 'Three-Side Open' ,'FOURSIDE' => 'Four-Side Open'];
                                                                    ?>
                                                                    <tr>
                                                                        <td><b>Corner Booth:</b></td>
                                                                        <td><?php echo $side[$data['premium']];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Specific Requirements:</b></td>
                                                                        <td><?php echo $data['specific'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Participation History in Plexpo:</b></td>
                                                                        <td><?php echo $data['participated_in_plexpo'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>GSPMA Membership:</b></td>
                                                                        <td><?php echo $data['gspma_membership_no'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>MSME Compliance:</b></td>
                                                                        <td><?php echo $data['msme_certificate'];?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                <table cellspacing="5px" cellpadding="5px" border="1" width="100%" style="border: 1px solid black;border-collapse: collapse;">
                                                                    <tr>
                                                                        <td colspan="2"><b>Price Bifurcation (INR)</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Registration Fees:</b></td>
                                                                        <td><?php echo $data['registration_fees'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Stall Rate:</b></td>
                                                                        <td><?php echo $data['stall_rate'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Premium for Corner Booth:</b></td>
                                                                        <td><?php echo $data['premium_for_corner_booth'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>GSPMA Discount (Subject to Evaluation):</b></td>
                                                                        <td>
                                                                            <?php 
                                                                                if($data['gspma_discount'] != 'No'){
                                                                                    if($data['gspma_status'] == 'APPROVE'){
                                                                                        echo $data['gspma_discount'];
                                                                                    } else {
                                                                                        echo "Rejected due to ".$data['gspma_status_reason'];
                                                                                    }
                                                                                } else {
                                                                                    echo "0";
                                                                                }
                                                                    ...
                                                                    <tr>
                                                                        <td><b>Loyalty Discount (Subject to Evaluation):</b></td>
                                                                        <td>
                                                                            <?php 
                                                                                if($data['loyalty_discount'] != 'No'){
                                                                                    if($data['loyalty_status'] == 'APPROVE'){
                                                                                        echo $data['loyalty_discount'];
                                                                                    } else {
                                                                                        echo "Rejected due to ".$data['loyalty_status_reason'];
                                                                                    }
                                                                                } else {
                                                                                    echo "0";
                                                                                }
                                                                    ...
                                                                    <tr>
                                                                        <td><b>Cash Discount (Applicable until 15th June 2024):</b></td>
                                                                        <td><?php echo $data['cash_discount'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>MSME Discount (Subject to Evaluation):</b></td>
                                                                        <td>
                                                                            <?php 
                                                                                if($data['msme_discount'] != 'No'){
                                                                                    if($data['msme_status'] == 'APPROVE'){
                                                                                        echo $data['msme_discount'];
                                                                                    } else {
                                                                                        echo "Rejected due to ".$data['msme_status_reason'];
                                                                                    }
                                                                                } else {
                                                                                    echo "0";
                                                                                }
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $data['early_bird_discount'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Special Discount:</b></td>
                                                                        <td><?php echo $data['special_discount'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Grand Total (Including 18% GST):</b></td>
                                                                        <td><?php echo $data['grand_total'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Amount to be Paid (If full payment is done before 15th June 2024):</b></td>
                                                                        <td><?php echo $data['grand_amount_before_date'];?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="2"><b>OR</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Amount to be Paid (If full payment is not done before 15th June 2024):</b></td>
                                                                        <td><?php echo $data['grand_amount_after_date'];?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                <b>Payment is to be made to the below details:</b><br />
                                                                <b>A/c. Name:</b> GUJARAT STATE PLASTIC MANUFACTURERS ASSOCIATION <br />
                                                                <b>Bank:</b> Bank of India. <br />
                                                                <b>Branch:</b> Paldi, Ahmedabad <br />
                                                                <b>A/c No.:</b> 201120100000151 <br />
                                                                <b>IFSC Code:</b> BKID0002011 <br />
                                                                <b>UPI:</b> boism-9426426567@boi
                                                                <b>PAN:</b> AAATG3563A <br />
                                                                <b>GSTN:</b> 24AAATG3563A1Z9<br />
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                To avail of the cash discount mentioned in the price bifurcation, kindly ensure full payment is made before 15th June 2024. Once done, please share the payment details with the PLEXPOINDIA team. <br /><br />

                                                                In case of any queries or require further assistance, please do not hesitate to contact us. We are here to ensure your participation in PLEXPOINDIA 2024 is seamless and rewarding.
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="footer-font" style="font-family: LATO LIGHT, sans-serif;font-size: 14px; line-height: 18px;color: #707070;">
                                                                            ...
                                                                            <!-- <a class="footer-font" href="https://havyajewels.fltstaging.com/privacy-policy" style="font-family: LATO LIGHT, sans-serif; font-size: 14px; line-height: 18px; color: #707070;text-decoration: underline;" target="_blank">Privacy Policy</a>
                                                                            &nbsp;&nbsp;&nbsp;
