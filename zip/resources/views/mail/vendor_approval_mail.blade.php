                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="title-font" style="font-family: LATO LIGHT, sans-serif;font-size: 20px; line-height: 24px;color: #005040;font-weight: bold;">
                                                                Congratulations <?php echo $data['name'];?>,
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="body-font" style="font-family: LATO LIGHT, sans-serif;font-size: 16px; line-height: 24px; color: #99CC5E;">
                                                                Your Userprofile has been approved and you can add your inventory from below link: <a href="https://exhibitor.plexpoindia.org/user-panel/login" target="_blank"><b>Login Here To Continue</b></a>
                                                            </td>
                                                        </tr>
