                    ...
                    <table class="price-table table-container"
                        ...
                        <thead>
                            <tr style="border-top: 2px solid black; border-bottom: 2px solid black;">
                                ...
                                <td style="padding: 10px; font-weight: bold; border-right: 2px solid black;">Inward Quantity</td>
                                <td style="padding: 10px;">Remaining Quantity</td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td
                                    style="padding: 8px; border-bottom: 1px solid black; border-right: 1px solid black;">
                                    {{$data['inwarded'] }}</td>
                                <td style="padding: 8px; border-bottom: 1px solid black;">{{ abs($data['remaining']) }}</td>
                            </tr>
