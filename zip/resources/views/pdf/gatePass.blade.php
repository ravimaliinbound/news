                    ...
                    <table class="price-table table-container"
                        ...
                        <thead>
                            <tr style="border-top: 2px solid black; border-bottom: 2px solid black;">
                                <td style="padding: 10px; font-weight: bold; border-right: 2px solid black">Bale Number
                                </td>
                                <td style="padding: 10px; font-weight: bold; border-right: 2px solid black;">Than</td>
                                <td style="padding: 10px; font-weight: bold; border-right: 2px solid black;">Meter</td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td style="padding: 8px; border-bottom: 1px solid black; border-right: 1px solid black">
                                    {{ $data['Bale_number'] }}</td>
                                <td
                        ...
                        {{-- <tfoot style="font-weight: bold; margin-top: 222px !important;">
                            <tr style="font-weight: bold; border-top: 2px solid black;">
                                <td colspan="2" style="padding: 10px; text-align: right;border-right: 1px solid black; ">Total:</td>
                        ...
                        <tr>
                            <td style="width: 100%; vertical-align: top; padding: 10px;">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <td class="label" style="font-weight: bold;;border-bottom: 1px solid black;">Car Number:</td>
                                        <td style=";border-bottom: 1px solid black;">{{ $data['car_number'] }}</td>
                                    </tr>
                                    <tr>
                                        <td class="label" style="font-weight: bold;border-bottom: 1px solid black;">Driver Name:</td>
                                        <td style="border-bottom: 1px solid black;">{{ $data['driver_name'] }}</td>
                                    </tr>
                                </table>
                            </td>
