...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Add Sample</h4>
            ...
            <form class="custom-validation" action="{{ route('admin.sample.store') }}" method="post" id="sampleForm"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" placeholder="Please select name">
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="quantity" class="form-control" id="quantity"  placeholder="Please select quanlity">
                                </div>
