...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Edit Qualtity</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Edit Quality</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <form class="custom-validation" action="" method="post" id="qualityForm"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name"
                                        name="name" value="{{ $quality->name }}" placeholder="Quality name">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="size" name="size" required
                                       value="{{ $quality->size }}" placeholder="Size" step="any">
                                </div>
