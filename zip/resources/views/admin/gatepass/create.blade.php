...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form class="custom-validation" action="{{ route('admin.gatepass.store') }}" method="post" id="gatepass_form"
                            ...
                            <div class="card-body">
                                ...
                                <div id="jobber_meter_section" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="meter" class="form-control" id="meter" >
                                    </div>
                                    <div class="mb-3">
                                        <label for="than" class="form-label">Than<span class="mandatory red">*</span></label>
                                        <input type="text" name= "than"class="form-control" id="than" >
                                    </div>
