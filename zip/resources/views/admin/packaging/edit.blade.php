            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Edit Packaging Slip</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Edit Packaging Slip</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="receipt_number" class="form-control" id="receipt_number"
                                            value="{{ $packaging->receipt_number }}" readonly>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="jober_name" class="form-control" id="jober_name"
                                            value="{{ $packaging->jober_name }}" placeholder="Jober Name">
                                    </div>
                                    ...
                                    <div class="form-group mb-3 row">
                                            ...
                                            <select name="quality" class="form-control" id="quality">
                                                ...
                                                @foreach ($qualities as $quality)
                                                    <option value="{{ $quality->name }}" 
                                                        data-size="{{ $quality->size }}"
                                                        @if ($quality->name == old('quality', $packaging->quality)) selected @endif>
                                                    {{ $quality->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" step="any" name="size" class="form-control" id="size"
                                               value="{{ $quality->size }}" placeholder="Size" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="border p-3 rounded">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="assort" id="assort_yes"
                                                    value="yes" required>
                                                <label class="form-check-label" for="assort_yes">Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="assort" id="assort_no"
