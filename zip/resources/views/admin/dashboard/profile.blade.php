                    ...
                    <div class="card-body">
                        ...
                        <form class="custom-validation" action="{{ route('admin.updateProfile') }}" method="post" id="adminProfile">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Enter Name" value="{{ $admin->name }}" autocomplete="off" required/>
                            </div>

                            <div class="form-group mb-3">
                                <label for="email">Email<span style="color:red;">*</span></label>
                                <input type="email" class="form-control" name="email" placeholder="Enter Email" value="{{ $admin->email }}" required autocomplete="off" />
                            </div>
