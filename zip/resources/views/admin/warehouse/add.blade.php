...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Add Ware house</h4>
            ...
            <form class="custom-validation" action="{{ route('admin.warehouse.store') }}" method="post" id="warehouseForm"
                            ...
                            <div class="card-body">
                                ...
                                <!-- Hidden Jobber & Meter Fields -->
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"placeholder="Ware House name" >
                                    </div>                                                         
