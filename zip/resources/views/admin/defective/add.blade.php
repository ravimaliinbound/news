...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Add Defective Pics</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Add Defective Pics</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <form class="custom-validation" action="{{ route('admin.defective.store') }}" method="post" id="vendorCategory"
                                ...
                                <div id="jobber_meter_section" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="quantity"
                                            name="quantity" placeholder="Enter defective Quantity" required>
