            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Defective Pics list</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Defective Pics list</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                <a href="{{ route('admin.defective.add') }}" class="btn btn-primary float-right">
                                    Add Defective Pics
                                </a><br /><br />
                            </div>
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%;">Defective Quantity</th>
                                ...
                                <tbody>
                                    @foreach ($defective as $ov)
                                        <tr>
                                            <td>{{ $ov->id }}</td>
                                            <td>#{{ $ov->packaging_id }}</td>
                                            <td>{{ $ov->packagingSlip->jober_name ?? 'N/A' }}</td>
                                            <td>{{ $ov->packagingSlip->quality ?? 'N/A' }}</td>
                                            <td>{{ $ov->quantity ?? 'N/A' }}</td>
                                            <td>
                                                <a href="{{ route('admin.defective.defectivePass', base64_encode($ov->id)) }}">
