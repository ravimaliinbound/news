...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Edit Partial Inward </h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Edit Partial Inward</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <form class="custom-validation" action="" method="post" id="vendorCategory" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="jobber_meter_section" style="display: none;">
                                    <div class="form-group mb-3">
                                        <label for="jobber_name" class="form-label">Jobber Name <span
                                                class="mandatory red">*</span></label>
                                        <input type="text" class="form-control" id="jobber_name" readonly>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="inward_quantity" class="form-label">Inward Quantity <span
                                                class="mandatory red">*</span></label>
                                        <input type="text" class="form-control" id="inward_quantity" name="inward_quantity"
                                            placeholder="Enter Inward Quantity">
                                        <span id="inward_quantity_error" class="text-danger" style="display: none;"></span>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="inward_quantity" class="form-label">Inward Date <span
                                                class="mandatory red">*</span></label>
