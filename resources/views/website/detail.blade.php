            ...
            <div class="col-lg-8">
                ...
                <div class="row g-4">
                    <div class="col-6">
                        <div class="rounded overflow-hidden">
                            <img src="{{url('website/img/news-6.jpg')}}" class="img-zoomin img-fluid rounded w-100"
                                alt="">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="rounded overflow-hidden">
                            <img src="{{url('website/img/news-5.jpg')}}" class="img-zoomin img-fluid rounded w-100"
                                alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane fade show active">
                            <div class="row g-4 align-items-center">
                                <div class="col-3">
                                    <img src="{{url('website/img/footer-4.jpg')}}" class="img-fluid w-100 rounded"
                                        alt="">
                                </div>
                                <div class="col-9">
                                    <h3>Amelia Alex</h3>
                        ...
                        <div id="tab-2" class="tab-pane fade show">
                            <div class="row g-4 align-items-center">
                                <div class="col-3">
                                    <img src="{{url('website/img/footer-5.jpg')}}" class="img-fluid w-100 rounded"
                                        alt="">
                                </div>
                                <div class="col-9">
                                    <h3>Amelia Alex</h3>
                        ...
                        <div id="tab-3" class="tab-pane fade show">
                            <div class="row g-4 align-items-center">
                                <div class="col-3">
                                    <img src="{{url('website/img/footer-6.jpg')}}" class="img-fluid w-100 rounded"
                                        alt="">
                                </div>
                                <div class="col-9">
                                    <h3>Amelia Alex</h3>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center p-3 bg-white rounded">
                                <img src="{{url('website/img/chatGPT.jpg')}}" class="img-fluid rounded" alt="">
                                <div class="ms-3">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center p-3 bg-white rounded">
                                <img src="{{url('website/img/chatGPT-1.jpg')}}" class="img-fluid rounded" alt="">
                                <div class="ms-3">
                                    <a href="#" class="h5 mb-2">Lorem Ipsum is simply dummy text of the printing</a>
                                    <p class="text-dark mt-3 mb-0 me-3"><i class="fa fa-clock"></i> 06 minute read</p>
                                </div>
                ...
                <div class="bg-light rounded p-4">
                    ...
                    <div class="p-4 bg-white rounded mb-4">
                        <div class="row g-4">
                            <div class="col-3">
                                <img src="{{url('website/img/footer-4.jpg')}}" class="img-fluid rounded-circle w-100"
                                    alt="">
                            </div>
                            <div class="col-9">
                                <div class="d-flex justify-content-between">
