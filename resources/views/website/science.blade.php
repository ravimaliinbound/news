    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6" style="border-left: 2px solid deepskyblue;">
                <a href="{{ route('science') }}" class="display-5 text-dark mb-0 link-hover text-uppercase">Browsing : Science / Health</a>
            </div>
                            ...
                            <a href="{{ route('show_news', base64_encode($sci->id)) }}">
                                <div class="position-relative overflow-hidden">
                                    <img class="img-fluid w-100" style="height: 250px;"
                                        src="{{ asset('admin/upload/news/' . $sci->image) }}" alt="activity-user" />
                                </div>
                            </a>
                            <div class="py-3">
