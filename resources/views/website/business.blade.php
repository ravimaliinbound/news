    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6" style="border-left: 2px solid deepskyblue;">
                <a href="{{ route('business') }}" class="display-5 text-dark mb-0 link-hover text-uppercase">Browsing : Business</a>
            </div>
            ...
            <div class="col-lg-7 col-xl-8 mt-0">
                <div class="row">
                    @foreach ($business as $b)
                        <div class="col-lg-6">
                            <a href="{{ route('show_news', base64_encode($b->id)) }}">
                                <div class="position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="{{ asset('admin/upload/news/' . $b->image) }}"
                                ...
                                <div class="py-1">
                                    ...
                                    <big>
                                        <a href="{{ route('show_news', base64_encode($b->id)) }}">
                                            <b>
                                                <p class="text-dark mb-0 link-hover heads">{{$b->heading}}</p>
                                            </b>
                                        </a>
                                    </big>
                                    <small>
                                        <p class="text-secondary mt-2">By <span
                                                class="text-dark">{{ $b->admins->name }}</span> —
                                            &nbsp;<span>{{$b->date}}</span></p>
                                    </small>
                                </div>
                                @php
